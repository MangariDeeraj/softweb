...
<footer style="background-color:dodgerblue;margin-top: 210; border: none;">
    <P style="color:black ;"align="center">Designed and Devoloped by MANGARI DEERAJ </P>
</footer>
</html
...
<html>
    ...
    <body>
        ...
        <img src="back.png" height="500" width="800">
    </center>
    </body>
...
<html>
    ...
    <div CLASS="names">   
        <P style="margin-left:-20;">MR DEERAJ</P>    
        <P>MR HASIF</P>    
        <P>MR ADARSH</P>    
        <P>MR NAVEEN</P>    
        <P>MR VARDHAN</P>    
...
<body>
    ...
    <div class="company">
       ...
       <p> <b >Address</b></p>
        <p >KURAPALLI VILLAGE</p>
        <p >CHITTOOR</p>
        <p >ANDHRA PRADESH-5170002</p>
        <b >Email:deerajsaveetha@gmail.com</b>
